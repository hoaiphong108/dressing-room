//khai báo producer ban đầu quản lí
const inititalState = {
        productList: [{
                id: 'topcloth_1',
                type: "topclothes",
    ...
    //reducer : là một functon , nhận vào giads trị hiện taị đang quản lý , action từ component
    //xủa lí action => return giá trị mới sau khi chỉnh sưả
